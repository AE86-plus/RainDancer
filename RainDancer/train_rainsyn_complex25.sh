...
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_DIR}/outputs/train/rainsyn_complex25}"
CONFIG_TEMPLATE="${CONFIG_TEMPLATE:-${PROJECT_DIR}/options/rainsyn_complex25.json}"
...
: "${TRAIN_H5:?Set TRAIN_H5 to the RainSynComplex25 training H5 path.}"
: "${TEST_H5:?Set TEST_H5 to the RainSynComplex25 test H5 path.}"
