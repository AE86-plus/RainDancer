...
def load_model(multi_model_res, multi_model_haze, multi_model_s2, optimizer, opts, epoch):
    ...
    multi_model_res.epoch = epoch ## reset model epoch

    return multi_model_res, multi_model_haze, multi_model_s2, optimizer
