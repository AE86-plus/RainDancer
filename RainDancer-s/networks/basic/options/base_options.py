...
import os
import sys
sys.path.append("/data/booker/LN_base/Code_redrain/USDerain_v2/train_lnr/dclgan")
from dclgan_util import dcd_util
import torch
import models
import data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--no_dropout', type=dcd_util.str2bool, nargs='?', const=True, default=True,
