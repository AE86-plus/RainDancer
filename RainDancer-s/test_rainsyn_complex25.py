...
DATASET_SPEC = {
    "name": "RainSynComplex25_test",
    "type": "rainsyn",
    "config": REPO_ROOT / "options" / "rainsyn_complex25.json",
    "checkpoint": REPO_ROOT / "weights" / "rainsyn-complex25" / "best.pth.tar",
}

DEFAULT_OUTPUT_ROOT = REPO_ROOT / "outputs" / "inference" / "rainsyn_complex25"
TITLE = "RainDancer-s test on RainSynComplex25 (sliding 128 stride 64)"
...
def main():
    ...
    parser.add_argument("--test-h5", type=str, required=True, help="Path to the RainSynComplex25 test H5 file.")
